...
function (_React$Component) {
  ...
  _createClass(RichTextEditor, [{
    ...
    value: function render() {
      ...
      return React.createElement(Container, null, React.createElement(Toolbar, null, buttons), React.createElement(Content, null, React.createElement(Editor, _extends({
        ref: this.ref,
        plugins: plugins,
        value: value,
        onChange: onChange,
