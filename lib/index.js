...
var debug$1$1 = src$1('slate:before');
...
function BeforePlugin() {
  ...
  function onCompositionEnd(event, editor, next) {
    ...
    debug$1$1('onCompositionEnd', { event: event });
    next();
  }
  ...
  function onCompositionStart(event, editor, next) {
    ...
    debug$1$1('onCompositionStart', { event: event });
    next();
  }
  ...
  function onDragEnter(event, editor, next) {
    debug$1$1('onDragEnter', { event: event });
    next();
  }
  ...
  function onDragExit(event, editor, next) {
    debug$1$1('onDragExit', { event: event });
    next();
  }
  ...
  function onDragLeave(event, editor, next) {
    debug$1$1('onDragLeave', { event: event });
    next();
  }
  ...
  function onDragOver(event, editor, next) {
    ...
    debug$1$1('onDragOver', { event: event });
    next();
  }
...
function DOMPlugin() {
  ...
  return [beforePlugin].concat(toConsumableArray$2(plugins), [afterPlugin]);
}
...
var debug$2$1 = src$1('slate:leaves');
...
var debug$3$1 = src$1('slate:node');
...
var debug$6 = src$1('slate:content');
...
var debug$7 = src$1('slate:editor');
...
var getBorderByProp = function getBorderByProp(_ref2) {
  var isSeparated = _ref2.isSeparated;
  return isSeparated ? "solid thin ".concat(BORDER_COLOR) : 'none';
};

var Button = styled.div(_templateObject$3(), getBorderByProp, getColorByStatus);
...
var merge$2 = function merge(objs) {
  return objs.reduce(function (r, o) {
    return _objectSpread({}, r, o);
  }, {});
};

var createPlugin = merge$2;
...
var bold = (function () {
  return createPlugin([Hotkey('mod+b', handleHotKeyPress), RenderMark('bold', Mark$1), RenderButton(ToolbarButton$1)]);
});
...
var italic = (function () {
  return createPlugin([Hotkey('mod+i', handleHotKeyPress$1), RenderMark('italic', Mark$2), RenderButton(ToolbarButton$2)]);
});
...
var underlined = (function () {
  return createPlugin([Hotkey('mod+u', handleHotKeyPress$2), RenderMark('underlined', Mark$3), RenderButton(ToolbarButton$3)]);
});
...
var headingOne = (function () {
  return createPlugin([RenderNode(HEADING_ONE_NODE, Node$2), RenderButton(ToolbarButton$4)]);
});
...
var headingTwo = (function () {
  return createPlugin([RenderNode(HEADING_TWO_NODE, Node$3), RenderButton(ToolbarButton$5)]);
});
...
var Image = styled.img(_templateObject$5(), getBorderByStatus);
var FileInput = styled.input(_templateObject2());

var Node$4 = function Node(_ref2) {
  var node = _ref2.node,
...
var ToolbarButton$6 = function ToolbarButton(_ref3) {
...
var makeHandleUpload = function makeHandleUpload(editor) {
  return function (e) {
...
var image = (function () {
  return createPlugin([RenderNode(IMAGE_NODE, Node$4), RenderButton(ToolbarButton$6)]);
});
...
var ToolbarButton$7 = function ToolbarButton(_ref3) {
  var editor = _ref3.editor;
  return React.createElement(Button, {
    isSeparated: true,
...
var numberedList = function numberedList() {
  return createPlugin([RenderNode(NUMBERED_LIST_NODE, ListNode), RenderButton(ToolbarButton$7)]);
};
...
var ToolbarButton$8 = function ToolbarButton(_ref3) {
  var editor = _ref3.editor;
  return React.createElement(Button, {
    isSeparated: true,
...
var listItem = function listItem() {
  return createPlugin([RenderNode(LIST_ITEM_NODE, ItemNode)]);
};

var bulletedList = function bulletedList() {
  return createPlugin([RenderNode(BULLETED_LIST_NODE, ListNode$1), RenderButton(ToolbarButton$8)]);
};
...
var plugins = [branch(), bold(), italic(), underlined(), headingOne(), headingTwo(), image(), numberedList(), bulletedList(), listItem()];
...
function (_React$Component) {
  ...
  _createClass(RichTextEditor, [{
    ...
    value: function render() {
      ...
      var buttons = editor && plugins.map(function (_ref) {
        var _ref$renderButton = _ref.renderButton,
            renderButton = _ref$renderButton === void 0 ? noop$1 : _ref$renderButton;
        return renderButton(editor);
      });
      return React.createElement(Container, null, React.createElement(Toolbar, null, buttons), React.createElement(Content$1, null, React.createElement(Editor$1, {
        ref: this.ref,
        plugins: plugins,
        value: value,
        onChange: onChange,
