...
function ReactPlugin() {
  ...
  function renderNode(props, editor, next) {
    ...
    return React.createElement(
      Tag,
      _extends$2({}, attributes, { style: style }),
      children
    );
  }
...
var Editor$1 = function (_React$Component) {
  ...
  function Editor$$1() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = Editor$$1.__proto__ || Object.getPrototypeOf(Editor$$1)).call.apply(_ref, [this].concat(args))), _this), _this.state = { value: _this.props.defaultValue
      ...
      _this.tmp.resolves++;
      var react = ReactPlugin(_extends$2({}, _this.props, {
  ...
  createClass$1(Editor$$1, [{
    ...
    value: function render() {
      debug$7('render', this);
      var props = _extends$2({}, this.props, { editor: this
      ...
      var children = this.controller.run('renderEditor', _extends$2({}, props, {
        value: value
      }));
      return children;
    }
