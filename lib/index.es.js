...
var _initialiseProps$1 = function _initialiseProps() {
  ...
  this.renderLeaf = function (leaves, leaf, index, offset) {
    ...
    return React$1.createElement(Leaf$1, {
      key: node.key + '-' + index,
      block: block,
      editor: editor,
      index: index,
...
var Void = function (_React$Component) {
  ...
  createClass$1(Void, [{
    ...
    value: function render() {
      ...
      var spacer = React$1.createElement(
        Tag,
...
var _initialiseProps$2 = function _initialiseProps() {
  ...
  this.renderText = function () {
    ...
    return React$1.createElement(Text$1, {
...
var Node$1 = function (_React$Component) {
  ...
  createClass$1(Node$$1, [{
    ...
    value: function render() {
      ...
      return editor.query('isVoid', node) ? React$1.createElement(
        Void,
        this.props,
        element
      ) : element;
...
var Content = function (_React$Component) {
  ...
  function Content() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.tmp = {
      ...
      return React$1.createElement(Node$1, {
        block: null,
        editor: editor,
        decorations: decorations,
        isSelected: isSelected,
...
var Button = styled('span')(_templateObject(), function (props) {
...
var Menu = styled('div')(_templateObject3());
var Toolbar = styled(Menu)(_templateObject4());
...
var bold = (function () {
  return [Hotkey('mod+b', function (editor) {
    return editor.toggleMark('bold');
  }), RenderMark('bold', function (props) {
    return React$1.createElement("strong", null, props.children);
  }), RenderButton(function (_ref) {
...
//   ...RenderMark('bold', props => <strong>{props.children}</strong>),
// })

var initialValue = Value.fromJSON({
  document: {
    nodes: [{
      object: 'block',
      type: 'paragraph',
...
var plugins = [bold().reduce(function (r, p) {
  return _objectSpread({}, r, p);
}, {})];
console.log(plugins);
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return React$1.createElement("div", null, React$1.createElement(Toolbar, null, plugins.map(function (plugin) {
        var Component = plugin.renderButton();
        return React$1.createElement(Component, {
          onClick: _this2.handleClick
        });
      })), React$1.createElement(Editor$1, {
        plugins: plugins,
