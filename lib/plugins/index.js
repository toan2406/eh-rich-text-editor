...
var merge = function merge(objs) {
  return objs.reduce(function (r, o) {
    return _objectSpread({}, r, o);
  }, {});
};

var createPlugin = merge;

var RenderButton = function RenderButton(Component) {
  return {
    renderButton: function renderButton(props, editor) {
...
var hasBlock = function hasBlock(editor, type) {
  return editor.value.blocks.some(function (node) {
    return node.type === type;
  });
};

var hasWrappedBlock = function hasWrappedBlock(editor, type) {
  return editor.value.blocks.some(function (node) {
    return editor.value.document.getClosest(node.key, function (parent) {
...
var IMAGE_PLACEHOLDER_COLOR = '#ccc';
...
styled.div(_templateObject(), BORDER_COLOR);
...
styled.div(_templateObject$1(), BORDER_COLOR);
...
var Button = styled.div(_templateObject$4(), getBorderByProp$1, getColorByStatus, Menu);
...
var branch = (function () {
  return createPlugin([RenderButton(ToolbarButton)]);
});
...
var Hotkey = function Hotkey(hotkey, fn) {
  return {
    onKeyDown: function onKeyDown(event, editor, next) {
      if (!lib_3(hotkey, event)) return next();
...
var RenderMark = function RenderMark(type, Component) {
  return {
...
var RenderNode = function RenderNode(type, Component) {
  return {
...
var RenderNodes = function RenderNodes(rules) {
  return {
    renderNode: function renderNode(props, editor, next) {
      var attributes = props.attributes,
          children = props.children,
          node = props.node,
          isFocused = props.isFocused;
      return rules.reduce(function (element, rule) {
...
var PARAGRAPH_NODE = 'paragraph';
var HEADING_ONE_NODE = 'heading-one';
var HEADING_TWO_NODE = 'heading-two';
var LIST_ITEM_NODE = 'list-item';
var BULLETED_LIST_NODE = 'bulleted-list';
var NUMBERED_LIST_NODE = 'numbered-list';
var IMAGE_NODE = 'image';
var TABLE_NODE = 'table';
var TABLE_ROW_NODE = 'table-row';
var TABLE_CELL_NODE = 'table-cell';
var DEFAULT_NODE = PARAGRAPH_NODE;
...
var ToolbarButton$1 = function ToolbarButton(_ref2) {
  var editor = _ref2.editor;
  return React.createElement(Button, {
    onClick: makeHandleClick(editor)
  }, React.createElement(Icon, null, "looks_one"));
};

var makeHandleClick = function makeHandleClick(editor) {
  return function () {
    var isList = hasBlock(editor, LIST_ITEM_NODE);
    var isActive = hasBlock(editor, HEADING_ONE_NODE);

    if (isList) {
      editor.setBlocks(isActive ? DEFAULT_NODE : HEADING_ONE_NODE).unwrapBlock(BULLETED_LIST_NODE).unwrapBlock(NUMBERED_LIST_NODE);
    } else {
...
var headingOne = (function () {
  return createPlugin([RenderNode(HEADING_ONE_NODE, Node), RenderButton(ToolbarButton$1)]);
});

var Node$1 = function Node(_ref) {
  var children = _ref.children,
      data = _ref.node.data;
...
var ToolbarButton$2 = function ToolbarButton(_ref2) {
  var editor = _ref2.editor;
  return React.createElement(Button, {
    isSeparated: true,
    onClick: makeHandleClick$1(editor)
  }, React.createElement(Icon, null, "looks_two"));
};

var makeHandleClick$1 = function makeHandleClick(editor) {
  return function () {
    var isList = hasBlock(editor, LIST_ITEM_NODE);
    var isActive = hasBlock(editor, HEADING_TWO_NODE);

    if (isList) {
      editor.setBlocks(isActive ? DEFAULT_NODE : HEADING_TWO_NODE).unwrapBlock(BULLETED_LIST_NODE).unwrapBlock(NUMBERED_LIST_NODE);
    } else {
...
var headingTwo = (function () {
  return createPlugin([RenderNode(HEADING_TWO_NODE, Node$1), RenderButton(ToolbarButton$2)]);
});

var handleHotKeyPress = function handleHotKeyPress(editor) {
...
var ToolbarButton$3 = function ToolbarButton(_ref2) {
  var editor = _ref2.editor;
  return React.createElement(Button, {
    onClick: editor.toggleMark.bind(editor, 'bold')
  }, React.createElement(Icon, null, "format_bold"));
};

var bold = (function () {
  return createPlugin([Hotkey('mod+b', handleHotKeyPress), RenderMark('bold', Mark), RenderButton(ToolbarButton$3)]);
});

var handleHotKeyPress$1 = function handleHotKeyPress(editor) {
  return editor.toggleMark('italic');
};

var Mark$1 = function Mark(_ref) {
  var children = _ref.children;
  return React.createElement("em", null, children);
};

var ToolbarButton$4 = function ToolbarButton(_ref2) {
  var editor = _ref2.editor;
  return React.createElement(Button, {
    onClick: editor.toggleMark.bind(editor, 'italic')
  }, React.createElement(Icon, null, "format_italic"));
};

var italic = (function () {
  return createPlugin([Hotkey('mod+i', handleHotKeyPress$1), RenderMark('italic', Mark$1), RenderButton(ToolbarButton$4)]);
});

var handleHotKeyPress$2 = function handleHotKeyPress(editor) {
  return editor.toggleMark('underlined');
};

var Mark$2 = function Mark(_ref) {
  var children = _ref.children;
  return React.createElement("u", null, children);
};

var ToolbarButton$5 = function ToolbarButton(_ref2) {
  var editor = _ref2.editor;
  return React.createElement(Button, {
    isSeparated: true,
    onClick: editor.toggleMark.bind(editor, 'underlined')
  }, React.createElement(Icon, null, "format_underlined"));
};

var underlined = (function () {
  return createPlugin([Hotkey('mod+u', handleHotKeyPress$2), RenderMark('underlined', Mark$2), RenderButton(ToolbarButton$5)]);
});

var ToolbarButton$6 = function ToolbarButton(_ref) {
  var editor = _ref.editor;
  return React.createElement(Button, {
    onClick: makeHandleClick$2(editor)
  }, React.createElement(Icon, null, "format_align_left"));
};

var makeHandleClick$2 = function makeHandleClick(editor) {
  return function () {
    editor.setBlocks({
      data: {
        style: {
...
var alignmentLeft = (function () {
  return createPlugin([RenderButton(ToolbarButton$6)]);
});

var ToolbarButton$7 = function ToolbarButton(_ref) {
  var editor = _ref.editor;
  return React.createElement(Button, {
    onClick: makeHandleClick$3(editor)
  }, React.createElement(Icon, null, "format_align_center"));
};

var makeHandleClick$3 = function makeHandleClick(editor) {
  return function () {
    editor.setBlocks({
      data: {
        style: {
...
var alignmentCenter = (function () {
  return createPlugin([RenderButton(ToolbarButton$7)]);
});

var ToolbarButton$8 = function ToolbarButton(_ref) {
  var editor = _ref.editor;
  return React.createElement(Button, {
    isSeparated: true,
    onClick: makeHandleClick$4(editor)
  }, React.createElement(Icon, null, "format_align_right"));
};

var makeHandleClick$4 = function makeHandleClick(editor) {
  return function () {
    editor.setBlocks({
      data: {
        style: {
...
var alignmentRight = (function () {
  return createPlugin([RenderButton(ToolbarButton$8)]);
});

var ItemNode = function ItemNode(_ref) {
  var children = _ref.children;
  return React.createElement("li", null, children);
};

var ListNode = function ListNode(_ref2) {
  var children = _ref2.children;
  return React.createElement("ol", null, children);
};

var ToolbarButton$9 = function ToolbarButton(_ref3) {
  var editor = _ref3.editor;
  return React.createElement(Button, {
    isSeparated: true,
    onClick: makeHandleClick$5(editor)
  }, React.createElement(Icon, null, "format_list_numbered"));
};

var makeHandleClick$5 = function makeHandleClick(editor) {
  return function () {
    var isList = hasBlock(editor, LIST_ITEM_NODE);
    var isNumberedList = hasWrappedBlock(editor, NUMBERED_LIST_NODE);
    if (isList && isNumberedList) return editor.setBlocks(DEFAULT_NODE).unwrapBlock(NUMBERED_LIST_NODE);
    if (isList) return editor.unwrapBlock(BULLETED_LIST_NODE).wrapBlock(NUMBERED_LIST_NODE);
    return editor.setBlocks(LIST_ITEM_NODE).wrapBlock(NUMBERED_LIST_NODE);
  };
};

var numberedList = (function () {
  return createPlugin([RenderNodes([[NUMBERED_LIST_NODE, ListNode], [LIST_ITEM_NODE, ItemNode]]), RenderButton(ToolbarButton$9)]);
});

var ItemNode$1 = function ItemNode(_ref) {
  var children = _ref.children;
  return React.createElement("li", null, children);
};

var ListNode$1 = function ListNode(_ref2) {
  var children = _ref2.children;
  return React.createElement("ul", null, children);
};

var ToolbarButton$a = function ToolbarButton(_ref3) {
  var editor = _ref3.editor;
  return React.createElement(Button, {
    isSeparated: true,
    onClick: makeHandleClick$6(editor)
  }, React.createElement(Icon, null, "format_list_bulleted"));
};

var makeHandleClick$6 = function makeHandleClick(editor) {
  return function () {
    var isList = hasBlock(editor, LIST_ITEM_NODE);
    var isBulletedList = hasWrappedBlock(editor, BULLETED_LIST_NODE);
    if (isList && isBulletedList) return editor.setBlocks(DEFAULT_NODE).unwrapBlock(BULLETED_LIST_NODE);
    if (isList) return editor.unwrapBlock(NUMBERED_LIST_NODE).wrapBlock(BULLETED_LIST_NODE);
    return editor.setBlocks(LIST_ITEM_NODE).wrapBlock(BULLETED_LIST_NODE);
  };
};

var bulletedList = (function () {
  return createPlugin([RenderNodes([[BULLETED_LIST_NODE, ListNode$1], [LIST_ITEM_NODE, ItemNode$1]]), RenderButton(ToolbarButton$a)]);
});
...
var Leaf = function (_Record) {
  ...
  createClass(Leaf, [{
    ...
    value: function fromJSON(object) {
      ...
      var leaf = new Leaf({
        text: text,
        marks: Set(marks.map(Mark$3.fromJSON))
      });
  ...
  createClass(Decoration, [{
    ...
    value: function createProperties() {
      ...
      if (isPlainObject(a)) {
        ...
        if ('mark' in a) p.mark = Mark$3.create(a.mark);
        return p;
      }
  ...
  createClass(Selection, [{
    ...
    value: function createProperties() {
      ...
      if (isPlainObject(a)) {
        ...
        if ('marks' in a) p.marks = a.marks == null ? null : Mark$3.createSet(a.marks);
        return p;
      }
    ...
    value: function fromJSON(object) {
      ...
      var selection = new Selection({
        ...
        focus: Point.fromJSON(focus || {}),
        isFocused: isFocused,
        marks: marks == null ? null : new Set(marks.map(Mark$3.fromJSON))
      });
    ...
    value: function fromJSON(object) {
      ...
      try {
        for (var _iterator2 = ATTRIBUTES[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          if (key === 'properties' && type === 'merge_node') {
            v = Node$2.createProperties(v);
          }

          if (key === 'properties' && type === 'set_mark') {
            v = Mark$3.createProperties(v);
          }
...
Commands$1.unwrapBlockAtRange = function (editor, range, properties) {
  properties = Node$2.createProperties(properties);
...
Commands$2.setMarkByPath = function (editor, path, offset, length, mark, properties) {
  mark = Mark$3.create(mark);
  properties = Mark$3.createProperties(properties);
  var value = editor.value;
...
mixin$1(ModelInterface, [Block, Decoration, Document, Inline, Leaf, Mark$3, Node$2, Operation, Point, Range$1, Selection, Text, Value]);
...
var getBorderByStatus = function getBorderByStatus(_ref) {
  var selected = _ref.selected;
  return selected ? 'solid thin blue' : 'none';
};

var Image = styled.img(_templateObject$6(), getBorderByStatus);
var FileInput = styled.input(_templateObject2$1());
var Placeholder = styled.div.attrs({
  children: 'Uploading...'
})(_templateObject3(), getBorderByStatus, IMAGE_PLACEHOLDER_COLOR);

var Node$3 = function Node(_ref2) {
  var node = _ref2.node,
      isFocused = _ref2.isFocused,
      attributes = _ref2.attributes;
  var src = node.data.get('src');
  if (!src) return React.createElement(Placeholder, _extends({
    selected: isFocused
  }, attributes));
...
var makeHandleFileChange = function makeHandleFileChange(editor, uploadImage) {
  return function (e) {
    var file = e.target.files[0];
    if (!file) return;
    var image = Block.create({
      type: IMAGE_NODE,
      data: {
        src: ''
      }
    ...
    uploadImage(file).then(function (url) {
      return editor.setNodeByKey(image.key, {
        data: {
          src: url
        }
      });
...
var image = (function (_ref3) {
  var uploadImage = _ref3.uploadImage;
  return createPlugin([RenderNode(IMAGE_NODE, Node$3), RenderButton(function (_ref4) {
    var editor = _ref4.editor;
    return React.createElement(Button, {
      isSeparated: true
    }, React.createElement(Icon, null, "insert_photo"), React.createElement(FileInput, {
      type: "file",
...
function createTable(opts, columns, rows, textGetter) {
    var rowNodes = Range$2(0, rows).map(function (i) {
...
function moveSelectionBy(opts, editor, x, y) {
    ...
    var _normPos = normPos(x + colIndex, y + rowIndex, width, height),
        _normPos2 = _slicedToArray$1(_normPos, 2),
        absX = _normPos2[0],
        absY = _normPos2[1];
...
var Range$3 = immutable.Range,
    List$3 = immutable.List;
...
function makeSchema(opts) {
    ...
    var schema = {
        blocks: (_blocks = {}, _defineProperty$2(_blocks, opts.typeCell, {
        ...
        }), _defineProperty$2(_blocks, opts.typeRow, {
        ...
        }), _defineProperty$2(_blocks, opts.typeTable, {
            nodes: [{
    ...
    var normalizeNode = function normalizeNode(node, editor, next) {
        ...
        return function (editor) {
            return invalidRows.reduce(function (tr, _ref) {
                ...
                tr = Range$3(0, add).reduce(function (t) {
...
var StyledTable = styled.table(_templateObject$7(), BORDER_COLOR);
var StyledTableRow = styled.tr(_templateObject2$2(), BORDER_COLOR);
var StyledTableCell = styled.td(_templateObject3$1(), BORDER_COLOR);

var Table = function Table(_ref) {
  var attributes = _ref.attributes,
      children = _ref.children;
  return React.createElement(StyledTable, null, React.createElement("tbody", attributes, children));
};

var TableRow = function TableRow(_ref2) {
  var attributes = _ref2.attributes,
      children = _ref2.children;
  return React.createElement(StyledTableRow, attributes, children);
};

var TableCell = function TableCell(_ref3) {
  var attributes = _ref3.attributes,
      children = _ref3.children;
  return React.createElement(StyledTableCell, attributes, children);
};

var ToolbarButton$b = function ToolbarButton(_ref4) {
  var editor = _ref4.editor;
  var isTableSelected = editor.isSelectionInTable(editor.value);
  return React.createElement(Button, {
    isSeparated: true
  }, React.createElement(Icon, null, "border_all"), React.createElement(Menu, null, React.createElement(MenuItem, {
    isSeparated: true,
    disabled: isTableSelected,
    onClick: makeHandleInsertTable(editor)
  }, "Insert table"), React.createElement(MenuItem, {
    disabled: !isTableSelected,
    onClick: makeHandleInsertRow(editor)
  }, "Insert row"), React.createElement(MenuItem, {
    isSeparated: true,
    disabled: !isTableSelected,
    onClick: makeHandleInsertColumn(editor)
  }, "Insert column"), React.createElement(MenuItem, {
    disabled: !isTableSelected,
    onClick: makeHandleDeleteTable(editor)
  }, "Delete table"), React.createElement(MenuItem, {
    disabled: !isTableSelected,
    onClick: makeHandleDeleteRow(editor)
  }, "Delete row"), React.createElement(MenuItem, {
    disabled: !isTableSelected,
    onClick: makeHandleDeleteColumn(editor)
  }, "Delete column")));
};

var makeHandleInsertTable = function makeHandleInsertTable(editor) {
  return function () {
    return editor.insertTable();
  };
};

var makeHandleInsertRow = function makeHandleInsertRow(editor) {
  return function () {
    return editor.insertRow();
  };
};

var makeHandleInsertColumn = function makeHandleInsertColumn(editor) {
  return function () {
    return editor.insertColumn();
  };
};

var makeHandleDeleteTable = function makeHandleDeleteTable(editor) {
  return function () {
    return editor.removeTable();
  };
};

var makeHandleDeleteRow = function makeHandleDeleteRow(editor) {
  return function () {
    return editor.removeRow();
  };
};

var makeHandleDeleteColumn = function makeHandleDeleteColumn(editor) {
  return function () {
...
var table = (function () {
  return createPlugin([tablePlugin, RenderNodes([[TABLE_NODE, Table], [TABLE_ROW_NODE, TableRow], [TABLE_CELL_NODE, TableCell]]), RenderButton(ToolbarButton$b)]);
});

var Node$4 = function Node(_ref) {
  var children = _ref.children,
      data = _ref.node.data;
...
var defaultNode = (function () {
  return createPlugin([RenderNode(DEFAULT_NODE, Node$4)]);
});

export { alignmentCenter, alignmentLeft, alignmentRight, bold, branch, bulletedList, defaultNode, headingOne, headingTwo, image, italic, numberedList, table, underlined };
