...
var RenderButton = function RenderButton(Component) {
  return {
    renderButton: function renderButton(editor) {
...
export { branch, headingOne, headingTwo, bold, italic, underlined, alignmentLeft, alignmentCenter, alignmentRight, numberedList, bulletedList, image, table, defaultNode };
