...
var slate__default = _interopDefault(slate);
...
var Mark = function Mark(_ref) {
  var children = _ref.children,
      attributes = _ref.attributes;
  return React.createElement("strong", attributes, children);
};
...
var Mark$2 = function Mark(_ref) {
  var children = _ref.children,
      attributes = _ref.attributes;
  return React.createElement("u", attributes, children);
};
...
var makeHandleClick$2 = function makeHandleClick(editor) {
  return function () {
    return editor.value.blocks.forEach(function (block) {
      return editor.setNodeByKey(block.key, setIn(block.toJS(), ['data', 'style', 'textAlign'], 'left'));
    });
  };
};
...
var makeHandleClick$3 = function makeHandleClick(editor) {
  return function () {
    return editor.value.blocks.forEach(function (block) {
      return editor.setNodeByKey(block.key, setIn(block.toJS(), ['data', 'style', 'textAlign'], 'center'));
    });
  };
};
...
var makeHandleClick$4 = function makeHandleClick(editor) {
  return function () {
    return editor.value.blocks.forEach(function (block) {
      return editor.setNodeByKey(block.key, setIn(block.toJS(), ['data', 'style', 'textAlign'], 'right'));
    });
  };
};
...
var Node$2 = function Node(_ref2) {
  var isFocused = _ref2.isFocused,
      attributes = _ref2.attributes,
      data = _ref2.node.data;
...
var makeHandleFileChange = function makeHandleFileChange(editor, uploadImage) {
  return function (e) {
    ...
    uploadImage(file).then(function (_ref3) {
      var src = _ref3.src,
          meta = _ref3.meta;
...
var schema = {
  document: {
    ...
    normalize: function normalize(editor, _ref4) {
      var code = _ref4.code,
          node = _ref4.node,
          child = _ref4.child;
      ...
      switch (code) {
        case 'last_child_type_invalid':
          {
            var paragraph = slate.Block.create('paragraph');
...
var image = (function (_ref5) {
  var uploadImage = _ref5.uploadImage;
  return createPlugin([{
    schema: schema
  }, RenderNode(IMAGE_NODE, Node$2), RenderButton(function (_ref6) {
...
function createCell(opts, text) {
    ...
    return slate__default.Block.create({
        type: typeCell,
        nodes: [slate__default.Block.create({
            type: typeContent,
            nodes: [Text.fromJSON({
                object: 'text',
                text: text
...
var Text$1 = slate__default.Text;
...
var Text$2 = slate__default.Text;
...
function makeSchema(opts) {
    ...
    var schema = {
        blocks: (_blocks = {}, _defineProperty$1(_blocks, opts.typeCell, {
        ...
        }), _defineProperty$1(_blocks, opts.typeRow, {
        ...
        }), _defineProperty$1(_blocks, opts.typeTable, {
            nodes: [{
...
var Table = function Table(_ref) {
  ...
  return React.createElement(StyledTable, attributes, React.createElement("tbody", null, children));
};
...
var Node$3 = function Node(_ref) {
  var children = _ref.children,
      attributes = _ref.attributes,
      data = _ref.node.data;
  return React.createElement("p", _extends({}, attributes, {
    style: data.get('style')
  }), children);
};

var defaultNode = (function () {
  return createPlugin([RenderNode(DEFAULT_NODE, Node$3)]);
});

exports.alignmentCenter = alignmentCenter;
exports.alignmentLeft = alignmentLeft;
exports.alignmentRight = alignmentRight;
exports.bold = bold;
